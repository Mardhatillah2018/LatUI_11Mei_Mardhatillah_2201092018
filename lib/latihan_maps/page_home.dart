...
import 'package:mobile_2/latihan_maps/page_detail_kampus.dart';
import 'package:mobile_2/latihan_maps/page_maps_all.dart';

import '../latihan_maps/model_kampus.dart';
...
class _KampusListState extends State<KampusList> {
  ...
  Future<ModelKampus> fetchKampus() async {
    final response = await http.get(Uri.parse('http://192.168.179.154/kampusDB/getKampus.php'));
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(
                                        'http://192.168.179.154/kampusDB/gambar/${kampus.gambarKampus}'),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
